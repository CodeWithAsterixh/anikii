    ...
    <div className="w-full h-fit">
      ...
      <div className="w-full pt-40 pb-10 relative isolate z-0">
        ...
        <div className="w-full relative px-4 flex flex-col sm:grid grid-cols-[13rem,1fr] justify-between gap-4">
          ...
          <div className="w-full min-h-72 p-5 flex flex-col justify-between bg-accent rounded-lg">
      ...
      <div className="h-fit min-h-[100vh] bg-accent z-10 relative rounded-t-lg isolate">
        <header className="w-full flex items-center justify-between py-3 bg-white backdrop-blur-3xl z-10 sticky top-16">
          <div
            className={clsx(
