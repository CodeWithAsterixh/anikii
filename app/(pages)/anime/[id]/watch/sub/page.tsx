...
export default function SubPage() {
  ...
  useEffect(() => {
    if(state.subStream?.data){
      const isAvailable = !!state.subStream?.data?.stream_links.find(s => s.name==="mp4upload") 
  ...
  return (
    <div className='p-2'>
      ...
      {
        isStreamAvailable&&
        <VideoPlayer src={`https://api-anikii.onrender.com/anime/${id}/stream/ep/1/live`} name={isStreamAvailable.anime_info.title}/>
      }
